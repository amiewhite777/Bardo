 ...
 */
export function checkHumanQualification(state: ScoringState, responses: QuizResponse[]): void {
 ...
 */
export function checkDevaQualification(state: ScoringState, responses: QuizResponse[]): void {
 ...
 */
export function handleHumanQualificationFailure(state: ScoringState): void {
 ...
 */
export function handleDevaBypass(state: ScoringState): void {
...
// Helper function
function getSortedRealmScores(state: ScoringState) {
  const realms = ['Hell', 'HungryGhost', 'Animal', 'Human', 'Asura', 'Deva'] as const;
  return realms
