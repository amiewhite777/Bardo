import { SECTION_WEIGHTS, FORM_POPULATIONS } from './constants.js';
 ...
 */
export function initializeScoringState() {
 ...
 */
export function getResponse(responses, questionId) {
 ...
 */
export function applyWeights(state) {
    const realms = ['Hell', 'HungryGhost', 'Animal', 'Human', 'Asura', 'Deva'];
    for (const realm of realms) {
 ...
 */
export function getHighestRealm(state) {
    const realms = ['Hell', 'HungryGhost', 'Animal', 'Human', 'Asura', 'Deva'];
    let maxScore = -1;
    let maxRealm = 'Animal';
    for (const realm of realms) {
 ...
 */
export function getSortedRealms(state) {
    const realms = ['Hell', 'HungryGhost', 'Animal', 'Human', 'Asura', 'Deva'];
    return realms
 ...
 */
function generateResult(state, session) {
