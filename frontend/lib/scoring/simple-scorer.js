 ...
 */
export function calculateSimpleResult(session) {
    ...
    const sortedRealms = Object.entries(normalizedScores)
        .sort((a, b) => b[1] - a[1]);
    const primaryRealm = sortedRealms[0][0];
 ...
 */
function calculateConsistencyScore(realmScores) {
 ...
 */
function detectBasicShadowFlags(realmScores, session) {
    const flags = [];
 ...
 */
function calculateBasicShadowGap(realmScores) {
...
//# sourceMappingURL=simple-scorer.js.map